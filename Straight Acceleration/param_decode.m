...
function[mass, L, h, b, m_u,Tm, N, Im, Ip, r, rho, Cd, A, Crr, eta g, Cl] = param_decode(parameters)
...
Cl = parameters(17); %coefficient of lift (convention: positive lift = downforce)
end
