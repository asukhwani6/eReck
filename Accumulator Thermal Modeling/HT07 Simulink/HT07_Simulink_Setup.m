...
mCell = 0.252*nCell; %kg
mFin = 0.0195*nCell; %kg
mInterconnect = 0.0034*nCell; %kg
mInterconnectBolt = 0.00092*nCell; %kg
mInterconnectNut = 0.00058*nCell; %kg
mInterconnectBoltTotal = mInterconnectBolt * 2;
mInterconnectNutTotal = mInterconnectNut * 2;
mCover = 2; %kg
mCoverAdj = mCover; %kg/cell
mContainer = 4.2; %kg
mContainerAdj = mContainer; %kg/cell

% Cell Tab Length of Copper - TUNED VARIABLE REASONABLE CONFIDENCE
tabLength = 0.03; %m
tabThickness = 0.0002; %m
tabWidth = 0.025; %m
tabArea = tabWidth*tabThickness*nCell; %m^2
kCopper = 386; %W/m*K
...
AH = 13.5;
SOC0 = 1;
dOCVdT = nCell*([-0.5346   -0.7334   -0.6375   -0.3737   -0.2813   -0.2087   -0.1267   -0.2182    0.2900   -0.3980   -0.2292]/1000);
...
IRVec = nCell*([2.3466,1.9787,1.6894,1.4706,1.3142,1.2120,1.1558,1.1376,1.1493,1.1826] / 1000);