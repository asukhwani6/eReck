...
function [f_x, f_y] = fff(FzTires, v,r,Parameters,graph)
    ...
    driverFactorLong = Parameters.driverFactorLong;
    driverFactorLat = Parameters.driverFactorLat;
    tireFactor = Parameters.tireFactor;
    
    f_fx = @(x) driverFactorLong*tireFactor*(-0.001379*x.^2 + 3.542*x + 7.922);
    f_fy = @(x) driverFactorLat*tireFactor*(-0.002103*x.^2 + 2.892*x + 13.71);
