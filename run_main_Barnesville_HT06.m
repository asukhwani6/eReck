...
%% Overlay With Fastest Recorded Lap Data
...
mask = (vehicle_speed(:,1) >= mintime) & (vehicle_speed(:,1) <= maxtime);
...
t_accel = S.lat_accel(:,1)/1000;
lat_accel = S.lat_accel(:,2);
long_accel = S.long_accel(:,2);

mask = (t_accel >= mintime) & (t_accel <= maxtime);
...
title('g-g Diagram Barnesville Shootout Simulated')
